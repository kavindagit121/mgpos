...
public class LoginController{
	   ...
	   // private Statement statement;
	    ...
	    void initialize() throws ClassNotFoundException, SQLException, InstantiationException, IllegalAccessException {
			...
			//TODO: change login page colour here.
			wallpaper.setBackground(new Background(new BackgroundFill(Color.AQUA, CornerRadii.EMPTY, Insets.EMPTY)));
	        //database
        	...
        	if(!id.equals(realId) && !pw.equals(realPw)) {
				...
				System.out.println("login fail Error showed");
		    		...
		    		if(isInteger(id+"")) {
						...
						all.getDialogPane().setStyle("-fx-font-family: 'serif'");
		    			all.showAndWait();
